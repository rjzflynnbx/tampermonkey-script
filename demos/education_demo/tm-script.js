...
(function () {
    ...
    // Start Demo Settings -----------------------------------------------------------------------------------------------
    const BOXEVER_CLIENT_KEY = SPINSHOP_CLIENT_KEY;
    const BOXEVER_POINT_OF_SALE = SPINSHOP_DEFAULT_POS;
...
function showUnitCompleteToast() {
    const Toast = Swal.mixin({
        toast: true,
        position: 'top-end',
        showConfirmButton: false,
    ...
    Toast.fire({
        icon: 'success',
        title: 'We recommend you start Math Pre-algebra: Ratios and rates'
    })
}